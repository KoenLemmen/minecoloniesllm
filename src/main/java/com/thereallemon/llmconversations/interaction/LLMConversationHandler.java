...
public class LLMConversationHandler extends AbstractInteractionResponseHandler {
    ...
    public Component getId() {
        return Component.literal(TYPE_ID);
    }
    ...
    @Override
    public java.util.List<IInteractionResponseHandler> genChildInteractions() {
        return new ArrayList<>();
    }

    @Override
    public boolean onClientResponseTriggered(int optionIndex, Player player, ICitizenDataView citizenDataView, BOWindow window) {
        // Not used for LLM conversations - responses are handled via chat
        return false;
    }

    @Override
    public void onServerResponseTriggered(int optionIndex, Player player, ICitizenData citizenData) {
        // Not used for LLM conversations - responses are handled via chat
    }
    ...
    public boolean hasParent(Component component) {
        return false;
    }
